...
Version 2.15 of the program is available as the compressed tar file “vpulse_v2p15_080524.tar.gz” and may be downloaded from the URL provided in reference [1].
...
$ tar -xvzf vpulse_v2p15_080524.tar.gz						Example command line [3]

This will create a directory vpulse_v2p15 and extract its directory structure:
...
This README.txt file is contained in the top level directory of vpulse_v2p15. A script file "runline_example.sh" containing a sample program line is contained in the example directory, and the documentation file in Portable Document Format is contained in the Documentation directory.
 
References:
